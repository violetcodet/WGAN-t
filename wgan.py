...
#import tensorflow.compat.v1.contrib as tc
from visualize import *


class WassersteinGAN(object):
    def __init__(self, g_net, d_net, x_sampler, z_sampler, data, model,output):
        self.model = model
        self.data = data
        self.output=output
        self.g_net = g_net
    ...
    def train(self, batch_size=64, num_batches=1000000):
        ...
        for t in range(0, num_batches):
            ...
            if t % 100 == 0:
                ...
                fig.savefig('logs/{}/{}.pdf'.format(self.output, t/100))
...
if __name__ == '__main__':
    ...
    wgan = WassersteinGAN(g_net, d_net, xs, zs, args.data, args.model,args.output)
    wgan.train()
